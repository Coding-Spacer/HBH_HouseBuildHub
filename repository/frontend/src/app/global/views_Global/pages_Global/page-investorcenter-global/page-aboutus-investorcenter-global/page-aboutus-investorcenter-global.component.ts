...
@Component({
  selector: 'app-page-aboutus-investorcenter-global',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './page-aboutus-investorcenter-global.component.html',
  styleUrl: './page-aboutus-investorcenter-global.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PageAboutusInvestorcenterGlobalComponent { }
