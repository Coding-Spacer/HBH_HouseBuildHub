...
@Component({
  selector: 'app-page-ourgoals-investorcenter-global',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './page-ourgoals-investorcenter-global.component.html',
  styleUrl: './page-ourgoals-investorcenter-global.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PageOurgoalsInvestorcenterGlobalComponent {}
