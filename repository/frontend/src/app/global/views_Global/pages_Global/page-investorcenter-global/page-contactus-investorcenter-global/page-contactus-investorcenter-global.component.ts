...
@Component({
  selector: 'app-page-contactus-investorcenter-global',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './page-contactus-investorcenter-global.component.html',
  styleUrl: './page-contactus-investorcenter-global.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PageContactusInvestorcenterGlobalComponent {}
