...
@Component({
  selector: 'app-page-investmentterms-investorcenter-global',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './page-investmentterms-investorcenter-global.component.html',
  styleUrl: './page-investmentterms-investorcenter-global.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})

export class PageInvestmenttermsInvestorcenterGlobalComponent {}
