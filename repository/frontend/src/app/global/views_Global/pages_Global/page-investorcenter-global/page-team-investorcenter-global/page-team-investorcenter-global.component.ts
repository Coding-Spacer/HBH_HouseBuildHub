...
@Component({
  selector: 'app-page-team-investorcenter-global',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './page-team-investorcenter-global.component.html',
  styleUrl: './page-team-investorcenter-global.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PageTeamInvestorcenterGlobalComponent {}
