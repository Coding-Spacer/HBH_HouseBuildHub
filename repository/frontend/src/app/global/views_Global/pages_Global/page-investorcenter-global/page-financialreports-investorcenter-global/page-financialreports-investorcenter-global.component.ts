...
@Component({
  selector: 'app-page-financialreports-investorcenter-global',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './page-financialreports-investorcenter-global.component.html',
  styleUrl: './page-financialreports-investorcenter-global.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PageFinancialreportsInvestorcenterGlobalComponent {}
